...
- Comprehensive test suite (138 tests) with strict isolation and mock compositor
...
**Current coverage (138 tests):**
- ✅ TUI logic and components (50 tests)
- ✅ Config validation and parsing (23 tests)
...
- `config.rs`: 23 tests - Config validation, sink resolution, default sink handling, regex safety
