...
**Note:** The centralized `[lints]` table approach (Rust 1.74+) allows workspace-wide configuration while keeping generated code suppressions co-located with their source. See `rust_plan.md` for complete migration history.
